...
typedef enum zfs_ioc {
	...
	*/
	...
	ZFS_BCB_READ = CTL_CODE(ZFSIOCTL_TYPE, 0x8E3, METHOD_BUFFERED, FILE_ANY_ACCESS),
	ZFS_BCB_WRITE = CTL_CODE(ZFSIOCTL_TYPE, 0x8E4, METHOD_BUFFERED, FILE_ANY_ACCESS),
	
	ZFS_IOC_LAST = CTL_CODE(ZFSIOCTL_TYPE, 0x8E5, METHOD_NEITHER, FILE_ANY_ACCESS),
} zfs_ioc_t;
